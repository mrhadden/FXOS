...
//
#define MOUSE_PTR_BYTE0          ((VOLATILE char FAR*)0xAF0706)
//  Byte 0 of Mouse Packet (you must write 3 Bytes)
#define MOUSE_PTR_BYTE1          ((VOLATILE char FAR*)0xAF0707)
//  Byte 1 of Mouse Packet (if you don't, then )
#define MOUSE_PTR_BYTE2          ((VOLATILE char FAR*)0xAF0708)
...
#define MOUSE_IDX        				((LPSTR)0x0000E0)
...
#define IDE_FEATURE   ((LPCHAR)0xAFE831)
