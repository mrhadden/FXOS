...
*
*/
HMENU CreateMenuResource(void void1)
{
    return ((CREATEMENURESOURCE)CALL_GUI_API(EXPORT_GUI_CREATEMENURESOURCE))(void1);
}
...
{
    return ((CREATEHORIZONTALSCROLLBAR)CALL_GUI_API(EXPORT_GUI_CREATEHORIZONTALSCROLLBAR))(hWndParent,caption,buttonId);
}
...
*
*/
HWND GetFocusWindow(VOID VOID1)
{
    return ((GETFOCUSWINDOW)CALL_GUI_API(EXPORT_GUI_GETFOCUSWINDOW))(VOID1);
}
