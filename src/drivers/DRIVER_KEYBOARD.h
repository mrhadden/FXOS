...
// DRIVER for SLOT 0
//
//#pragma section CODE=KEYBS00,offset $04:0000
//static LPVOID _k_driver_base = ((LPVOID)0x040000);
#pragma section CODE=KEYBS00,offset $04:0BE0
static LPVOID _k_driver_base = ((LPVOID)0x040BE0);
...
ULONG kbd_process_byte(BYTE sc, kbd_event_t* event);
BOOL kbd_is_valid_scancode(BYTE* bytes, ULONG len, ULONG* key_code);
BOOL kbd_is_key_pressed(ULONG key_code);
