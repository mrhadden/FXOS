...
BOOL k_gui_get_image_cache(UINT slot,ULONG destVMARelPage,PRECT prect)
{
	...
	if(slot < GUI_CACHE_SIZE)
	{
		...
		k_vdma_copy_address_ex(pDst,
							   (LPSTR)(GUI_CACHE_PAGE + GUI_CACHE_PAGE_OFFSET(slot)),
							   cw,ch);
	}
...
{
	k_draw_nonclient_area_ex(wndRect,clientRect,style,title,color,bgcolor,BITMAP_BACK);
}

void k_draw_nonclient_area_ex(PRECT wndRect,PRECT clientRect,UINT style,LPCSTR title,int color,int bgcolor,UINT page)
{
	...
	k_debug_integer("k_draw_nonclient_area_ex:cx:",cx);
	k_debug_integer("k_draw_nonclient_area_ex:cy:",cy);
	k_debug_integer("k_draw_nonclient_area_ex:width:",width);
	k_debug_integer("k_draw_nonclient_area_ex:height:",height);

	titleOffsetX = cx+2;
	titleOffsetY = cy+1;

	//k_debug_strings("k_draw_nonclient_area_ex:","enter");

	if(style & FXWS_VISIBLE != FXWS_VISIBLE)
	{
		k_debug_strings("k_draw_nonclient_area_ex::NOT RENDERING:",(LPCHAR)title);
		return;
	}

	//k_debug_strings("k_draw_nonclient_area_ex::RENDERING:",title);
	...
	*/
	...
	{
		//k_debug_strings("k_draw_nonclient_area_ex:","FXWS_SYSMENU");
	...
	{
		//k_debug_strings("k_draw_nonclient_area_ex:","FXWS_CAPTION");
	...
	{
		//k_debug_strings("k_draw_nonclient_area_ex:","FXWS_MAXIMIZEBOX");
	...
	{
		//k_debug_strings("k_draw_nonclient_area_ex:","FXWS_MINIMIZEBOX");
		maxminPos+=metric.width;
	...
	//k_debug_strings("k_draw_nonclient_area_ex:","exit");
}
