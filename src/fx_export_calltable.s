...
R2	equ	9
R3	equ	13
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\fx_export_calltable.c",0
;
;#include "fxkernel.h"
	...
	.eos
	.line	490
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\fx_export_calltable.c",2
;#include "fxkernel_exports.h"
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\fxkernel_exports.h",0
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\fx_exports.h",0
	.line	15
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\fxkernel_exports.h",5
	.line	55
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\fx_export_calltable.c",3
;#include "FXOS_DISPATCH_SDK.h"
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\FXOS_DISPATCH_SDK.h",0
	.line	12
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\fx_export_calltable.c",4
;
...
;{
	...
	.line	7
	code
	xdef	~~_k_initialize_call_table
	func
	.function	7
~~_k_initialize_call_table:
	longa	on
	longi	on
	tsc
	sec
...
;
;	switch(tableType)
	.sym	pzp,4,138,6,32,83
	.sym	tableType,8,16,6,16
	.line	9
	lda	<L2+tableType_0
	brl	L10001
;	{
...
;		_k_initialize_KERNEL_call_table(pzp);
	...
	pei	<L2+pzp_0+2
	pei	<L2+pzp_0
	jsl	~~_k_initialize_KERNEL_call_table
;		break;
	.line	13
	brl	L10002
...
;		_k_initialize_DOS_call_table(pzp);
	...
	pei	<L2+pzp_0+2
	pei	<L2+pzp_0
	jsl	~~_k_initialize_DOS_call_table
;		break;
	.line	16
	brl	L10002
...
;		_k_initialize_GFX_call_table(pzp);
	...
	pei	<L2+pzp_0+2
	pei	<L2+pzp_0
	jsl	~~_k_initialize_GFX_call_table
;		break;
	.line	19
	brl	L10002
...
;		_k_initialize_GUI_call_table(pzp);
	...
	pei	<L2+pzp_0+2
	pei	<L2+pzp_0
	jsl	~~_k_initialize_GUI_call_table
;		break;
	.line	22
	brl	L10002
...
;		_k_initialize_CON_call_table(pzp);
	...
	pei	<L2+pzp_0+2
	pei	<L2+pzp_0
	jsl	~~_k_initialize_CON_call_table
;		break;
	.line	25
	brl	L10002
;	}
...
;
	.line	31
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\fx_export_calltable.c",6
	xref	~~_k_initialize_GUI_call_table
	xref	~~_k_initialize_DOS_call_table
	xref	~~_k_initialize_GFX_call_table
	xref	~~_k_initialize_KERNEL_call_table
	xref	~~_k_initialize_CON_call_table
	.sym	~~_k_initialize_GUI_call_table,~~_k_initialize_GUI_call_table,65,18,0
	.sym	~~_k_initialize_DOS_call_table,~~_k_initialize_DOS_call_table,65,18,0
	.sym	~~_k_initialize_GFX_call_table,~~_k_initialize_GFX_call_table,65,18,0
	.sym	~~_k_initialize_KERNEL_call_table,~~_k_initialize_KERNEL_call_table,65,18,0
	.sym	~~_k_initialize_CON_call_table,~~_k_initialize_CON_call_table,65,18,0
	...
	.sym	~~_k_initialize_call_table,~~_k_initialize_call_table,65,2,0
