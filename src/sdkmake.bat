...
echo Compling FXOS_%%x_SDK.c
%COMPILER% %INCLUDES% %OPTIONS% -O FXOS_%%x_SDK.s FXOS_%%x_SDK.c
%ASSEMBLER% %ASM_OPTIONS% FXOS_%%x_SDK.s -o FXOS_%%x_SDK.obj
DEL /Q .\sdk\FX%%x.LIB
WDCLIB -a .\sdk\FX%%x.LIB FXOS_%%x_SDK.obj
COPY /Y FXOS_%%x_SDK.h .\sdk\FXOS_%%x_SDK.h
)

DEL /Q .\sdk\FXOS_DISPATCH_SDK.LIB
...
echo Compling FXOS_%%x_DISPATCH_SDK.c

%COMPILER% %INCLUDES% %OPTIONS% -O FXOS_%%x_DISPATCH_SDK.s FXOS_%%x_DISPATCH_SDK.c
%ASSEMBLER% %ASM_OPTIONS% FXOS_%%x_DISPATCH_SDK.s -o FXOS_%%x_DISPATCH_SDK.obj

WDCLIB -a .\sdk\FXOS_DISPATCH_SDK.LIB FXOS_%%x_DISPATCH_SDK.obj
