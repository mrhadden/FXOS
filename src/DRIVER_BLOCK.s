...
R2	equ	9
R3	equ	13
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_BLOCK.c",0
;
;#include "fxkernel.h"
	...
	.eos
	.line	475
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_BLOCK.c",2
;#include "drivers/DRIVER.h"
	...
	.line	115
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_BLOCK.c",3
;#include "drivers/DRIVER_SLOT_10.h"
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_SLOT_10.h",0
DSLT10	section	offset $04:3B60
	ends
	data
~~_k_s10_driver_base:
	dl	$43B60
	ends
	.line	7
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_BLOCK.c",4
;
;static FX_DEVICE_DRIVER DRIVER_SLOT_10 = {
	data
~~DRIVER_SLOT_10:
;										"DRIVER_SLOT_10\0",
	db	$44,$52,$49,$56,$45,$52,$5F,$53,$4C,$4F
	db	$54,$5F,$31,$30,$0,$0
	ds	16
;										"v1.0.0\0",
...
;#include "drivers/DRIVER_SLOT_11.h"
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_SLOT_11.h",0
...
~~_k_s11_driver_base:
	...
	ends
	.line	7
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_BLOCK.c",28
;
;
...
;#include "drivers/DRIVER_SLOT_12.h"
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_SLOT_12.h",0
DSLT12	section	offset $04:4740
	ends
	data
~~_k_s12_driver_base:
	dl	$44740
	ends
	.line	7
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_BLOCK.c",52
;
;
...
;#include "drivers/DRIVER_SLOT_13.h"
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_SLOT_13.h",0
DSLT13	section	offset $04:4D30
	ends
	data
~~_k_driver_base:
	dl	$44D30
	ends
	.line	8
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_BLOCK.c",76
;
;
...
;#include "drivers/DRIVER_SLOT_14.h"
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_SLOT_14.h",0
DSLT14	section	offset $04:5320
	ends
	data
~~_k_s14_driver_base:
	dl	$45320
	ends
	.line	7
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_BLOCK.c",100
;
;
...
;#include "drivers/DRIVER_SLOT_15.h"
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_SLOT_15.h",0
DSLT15	section	offset $04:5910
	ends
	data
~~_k_s15_driver_base:
	dl	$45910
	ends
	.line	7
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_BLOCK.c",124
;
;
...
;#include "drivers/DRIVER_SLOT_16.h"
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_SLOT_16.h",0
DSLT16	section	offset $04:5F00
	ends
	data
~~_k_s16_driver_base:
	dl	$45F00
	ends
	.line	7
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_BLOCK.c",148
;
;
...
;
	.line	171
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOS-Beta\src\drivers/DRIVER_BLOCK.c",167
	.sym	~~f_get_s16_driver,~~f_get_s16_driver,1098,3,32,87
	.sym	~~DRIVER_SLOT_16,~~DRIVER_SLOT_16,10,3,776,87
	.sym	~~_k_s16_driver_base,~~_k_s16_driver_base,129,3,32
	.sym	~~f_get_s15_driver,~~f_get_s15_driver,1098,3,32,87
	.sym	~~DRIVER_SLOT_15,~~DRIVER_SLOT_15,10,3,776,87
	.sym	~~_k_s15_driver_base,~~_k_s15_driver_base,129,3,32
	.sym	~~f_get_s14_driver,~~f_get_s14_driver,1098,3,32,87
	.sym	~~DRIVER_SLOT_14,~~DRIVER_SLOT_14,10,3,776,87
	.sym	~~_k_s14_driver_base,~~_k_s14_driver_base,129,3,32
	.sym	~~f_get_s13_driver,~~f_get_s13_driver,1098,3,32,87
	.sym	~~DRIVER_SLOT_13,~~DRIVER_SLOT_13,10,3,776,87
	.sym	~~_k_driver_base,~~_k_driver_base,129,3,32
	.sym	~~f_get_s12_driver,~~f_get_s12_driver,1098,3,32,87
	.sym	~~DRIVER_SLOT_12,~~DRIVER_SLOT_12,10,3,776,87
	.sym	~~_k_s12_driver_base,~~_k_s12_driver_base,129,3,32
	.sym	~~f_get_s11_driver,~~f_get_s11_driver,1098,3,32,87
	.sym	~~DRIVER_SLOT_11,~~DRIVER_SLOT_11,10,3,776,87
	.sym	~~_k_s11_driver_base,~~_k_s11_driver_base,129,3,32
	.sym	~~f_get_s10_driver,~~f_get_s10_driver,1098,3,32,87
	.sym	~~DRIVER_SLOT_10,~~DRIVER_SLOT_10,10,3,776,87
	.sym	~~_k_s10_driver_base,~~_k_s10_driver_base,129,3,32
