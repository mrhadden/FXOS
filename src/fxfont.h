...
#define WINICON_CHECK		 (0x07)
//#define WINICON_TITLE_BCLOSE (0x08)

#define WINICON_DOCUMENT     (0x0A)
#define WINICON_FOLDER       (0x0B)
...
#define ICON_WARNING 		  (0x06)
#define ICON_STOP	 		  (0x07)


#define EXPORT_FONT_SET(a)
#define EXPORT_FONT_SET(a)
