...
R2	equ	9
R3	equ	13
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOSv1\src\drivers/DRIVER_FMXKEYB.c",0
;#include "fxtypes.h"
	...
	.eos
	.line	1010
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOSv1\src\drivers/DRIVER_FMXKEYB.c",1
;#include "fxkernel.h"
	...
	.eos
	.line	400
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOSv1\src\drivers/DRIVER_FMXKEYB.c",2
;#include "drivers/DRIVER_KEYBOARD.h"
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOSv1\src\drivers/DRIVER_KEYBOARD.h",0
KEYBS00	section	offset $04:0000
	ends
	data
~~_k_driver_base:
	dl	$40000
	ends
	.line	7
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOSv1\src\drivers/DRIVER_FMXKEYB.c",3
;
;
;/*
...
L10003:
	lda	<L40+_time_out_1
	sta	<R0
	lda	<L40+_time_out_1+2
	sta	<R0+2
	lda	<L40+_time_out_1
	bne	L43
	dec	<L40+_time_out_1+2
L43:
	dec	<L40+_time_out_1
	lda	<R0
	ora	<R0+2
...
L1:
	...
	db	$64,$00,$45,$41,$54,$20,$30,$78,$46,$41,$00,$45,$41,$54,$20
	db	$30,$78,$45,$58,$00,$45,$58,$54,$52,$41,$20,$30,$78,$45,$30
	db	$00,$41,$46,$54,$45,$52,$20,$30,$78,$45,$30,$00,$4F,$56,$45
	db	$52,$46,$4C,$4F,$57,$00
	ends
;
;
;
	.line	494
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOSv1\src\drivers/DRIVER_FMXKEYB.c",346
	...
	.sym	~~kbd_wait,~~kbd_wait,65,2,0
	.sym	~~f_get_driver,~~f_get_driver,1098,3,32,83
	.sym	~~DRV_PORT_B,~~DRV_PORT_B,142,3,32
	.sym	~~DRV_PORT_A,~~DRV_PORT_A,142,3,32
	.sym	~~DRV_KBD_DATA_BUF,~~DRV_KBD_DATA_BUF,142,3,32
	.sym	~~DRV_KBD_CMD_BUF,~~DRV_KBD_CMD_BUF,142,3,32
	.sym	~~DRV_KBD_INPT_BUF,~~DRV_KBD_INPT_BUF,142,3,32
	.sym	~~DRV_KBD_OUT_BUF,~~DRV_KBD_OUT_BUF,142,3,32
	.sym	~~DRV_KBD_STATUS,~~DRV_KBD_STATUS,142,3,32
	.sym	~~DRV_STATUS_PORT,~~DRV_STATUS_PORT,142,3,32
	.sym	~~DRIVER_FMXKEYBOARD_U,~~DRIVER_FMXKEYBOARD_U,10,3,776,83
	.sym	~~DRIVER_FMXKEYBOARD,~~DRIVER_FMXKEYBOARD,10,3,776,83
	.sym	~~mouseport,~~mouseport,138,3,32,54
	.sym	~~kbport,~~kbport,138,3,32,54
	.sym	~~debugport,~~debugport,138,3,32,54
