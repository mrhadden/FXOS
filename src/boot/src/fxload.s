...
main  		        setas
                    ...
                    setaxl
                    LDX #<>MSG_FXLOADER           ; loading message
                    JSL PUTS

					SEI

                    setaxl
                    LDX #<>MSG_FXIRQ           ; loading message
                    JSL PUTS

					setas
					LDX #$0000
FILL_IRQ		    LDA @lIRQ_BLOCK,X
                	STA @lIRQ_START,X
                	INX
                	CPX #$0020
                	BNE FILL_IRQ
                    ...
                    setaxl
                    LDX #<>MSG_FXJUMP           ; loading message
                    JSL PUTS
...
MSG_FXLOADER		.null "Loading FX/OS...",13
MSG_FXIRQ			.null "Setting IRQ",13
MSG_FXJUMP			.null "Jumping to start...",13
...
IRQ_BLOCK			.text $00,$00,$00,$00,$89,$7E,$72,$7E,$A0,$7E,$71,$7E,$A0,$7E,$5A,$7E
					.text $A0,$7E,$A0,$7E,$A0,$7E,$A0,$7E,$A0,$7E,$A0,$7E,$00,$7D,$A0,$7E
